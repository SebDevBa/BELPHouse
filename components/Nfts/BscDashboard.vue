        ...
        <div class="row justify-content-center">
          <div class="col-xl-10 col-lg-12">
            <div class="tab-content pt-100">
              <div class="tab-pane fade show active" id="binance" role="tabpanel" aria-labelledby="binance-tab">
                <div class="row">
                  <div class="col-12">
                    <!-- Mint BSC start -->
                            ...
                            <div class="col-md-6 col-lg-6">
                              <div class="pricing_box text-center">
                                ...
                                <div class="pr_content">
                                  <div>
                                    <img src="~/assets/images/bnb.png" style="max-width: 200px; padding-top: 15px; padding-bottom: 15px;" alt="image">
                                  </div>
                                  <ul class="list_none">
